...
autocmd BufNewFile *.sml,*.ml exe "1," . 10 . "g/File Name :.*/s//File Name : " .expand("%")
autocmd BufNewFile *.sml,*.ml exe "1," . 10 . "g/Creation Date :.*/s//Creation Date : " .strftime("%d-%m-%Y")
autocmd Bufwritepre,filewritepre *.sml,*.ml execute "normal ma"
autocmd Bufwritepre,filewritepre *.sml,*.ml exe "1," . 10 . "g/Last Modified :.*/s/Last Modified :.*/Last Modified : " .strftime("%+")
...
autocmd Bufwritepre,filewritepre *.hs exe "1," . 10 . "g/Last Modified :.*/s/Last Modified :.*/Last Modified : " .strftime("%+")
...
autocmd BufNewFile *.yap,*.prolog,*.pl set smartindent syntax=prolog
...
autocmd Bufwritepre,filewritepre *.yap exe "1," . 10 . "g/Last Modified :.*/s/Last Modified :.*/Last Modified : " .strftime("%+")
...
autocmd Bufwritepre,filewritepre *.java exe "1," . 10 . "g/Last Modified :.*/s/Last Modified :.*/Last Modified : " .strftime("%+")
